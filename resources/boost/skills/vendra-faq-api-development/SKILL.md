...
- Add or update focused Pest coverage, then run `composer --working-dir=packages/vendra-faq-api test` and `composer --working-dir=packages/vendra-faq-api analyse`.
